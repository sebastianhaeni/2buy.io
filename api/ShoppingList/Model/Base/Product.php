...
abstract class Product implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ShoppingList\\Model\\Map\\ProductTableMap';
    ...
    /**
     * The value for the insuggestions field.
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $insuggestions;
    ...
    /**
     * Initializes internal state of ShoppingList\Model\Base\Product object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [insuggestions] column value.
     * 
     * @return boolean
     */
    public function getInSuggestions()
    {
        return $this->insuggestions;
    }
     ...
     * @return boolean
     */
    public function isInSuggestions()
    {
        return $this->getInSuggestions();
    }
     ...
     * @return $this|\ShoppingList\Model\Product The current object (for fluent API support)
     */
    public function setIdProduct($v)
    {
        ...
        if ($this->idproduct !== $v) {
            $this->idproduct = $v;
            $this->modifiedColumns[ProductTableMap::COL_IDPRODUCT] = true;
        }
    ...
    public function setIdCommunity($v)
    {
        ...
        if ($this->idcommunity !== $v) {
            $this->idcommunity = $v;
            $this->modifiedColumns[ProductTableMap::COL_IDCOMMUNITY] = true;
        }

        if ($this->aCommunity !== null && $this->aCommunity->getIdCommunity() !== $v) {
    ...
    public function setAddedBy($v)
    {
        ...
        if ($this->addedby !== $v) {
            $this->addedby = $v;
            $this->modifiedColumns[ProductTableMap::COL_ADDEDBY] = true;
        }
    ...
    /**
     * Sets the value of the [insuggestions] column.
     ...
     * @return $this|\ShoppingList\Model\Product The current object (for fluent API support)
     */
    public function setInSuggestions($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->insuggestions !== $v) {
            $this->insuggestions = $v;
            $this->modifiedColumns[ProductTableMap::COL_INSUGGESTIONS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductTableMap::translateFieldName('IdProduct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idproduct = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductTableMap::translateFieldName('IdCommunity', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('AddedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->addedby = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProductTableMap::translateFieldName('InSuggestions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->insuggestions = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ShoppingList\\Model\\Product'), 0, $e);
        }
    }
    ...
    {
        if ($this->aCommunity !== null && $this->idcommunity !== $this->aCommunity->getIdCommunity()) {
            $this->aCommunity = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->idproduct) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ProductTableMap::COL_IDPRODUCT . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ProductTableMap::COL_IDPRODUCT)) {
            $modifiedColumns[':p' . $index++]  = 'idProduct';
        }
        if ($this->isColumnModified(ProductTableMap::COL_IDCOMMUNITY)) {
            $modifiedColumns[':p' . $index++]  = 'idCommunity';
        }
        if ($this->isColumnModified(ProductTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ProductTableMap::COL_ADDEDBY)) {
            $modifiedColumns[':p' . $index++]  = 'addedBy';
        }
        if ($this->isColumnModified(ProductTableMap::COL_INSUGGESTIONS)) {
            $modifiedColumns[':p' . $index++]  = 'inSuggestions';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'addedBy':                        
                        ...
                        break;
                    case 'inSuggestions':                        
                        $stmt->bindValue($identifier, $this->insuggestions, PDO::PARAM_BOOL);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getIdCommunity(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getAddedBy(),
            $keys[4] => $this->getInSuggestions(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommunity) {
                ...
                $result[$key] = $this->aCommunity->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ShoppingList\Model\Product
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setIdCommunity($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAddedBy($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setInSuggestions($arr[$keys[4]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ShoppingList\Model\Product The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_IDPRODUCT)) {
            $criteria->add(ProductTableMap::COL_IDPRODUCT, $this->idproduct);
        }
        if ($this->isColumnModified(ProductTableMap::COL_IDCOMMUNITY)) {
            $criteria->add(ProductTableMap::COL_IDCOMMUNITY, $this->idcommunity);
        }
        if ($this->isColumnModified(ProductTableMap::COL_NAME)) {
            $criteria->add(ProductTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProductTableMap::COL_ADDEDBY)) {
            $criteria->add(ProductTableMap::COL_ADDEDBY, $this->addedby);
        }
        if ($this->isColumnModified(ProductTableMap::COL_INSUGGESTIONS)) {
            $criteria->add(ProductTableMap::COL_INSUGGESTIONS, $this->insuggestions);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ShoppingList\Model\Product (or compatible) type.
    ...
    {
        $copyObj->setIdCommunity($this->getIdCommunity());
        $copyObj->setName($this->getName());
        $copyObj->setAddedBy($this->getAddedBy());
        $copyObj->setInSuggestions($this->getInSuggestions());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ShoppingList\Model\Product Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildCommunity object.
     *
     * @param  ChildCommunity $v
     * @return $this|\ShoppingList\Model\Product The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommunity(ChildCommunity $v = null)
    {
        if ($v === null) {
            $this->setIdCommunity(NULL);
        } else {
            $this->setIdCommunity($v->getIdCommunity());
        }

        $this->aCommunity = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildCommunity object, it will not be re-added.
        if ($v !== null) {
            $v->addProduct($this);
        }
    ...
    /**
     * Get the associated ChildCommunity object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildCommunity The associated ChildCommunity object.
     * @throws PropelException
     */
    public function getCommunity(ConnectionInterface $con = null)
    {
        if ($this->aCommunity === null && ($this->idcommunity !== null)) {
            $this->aCommunity = ChildCommunityQuery::create()->findPk($this->idcommunity, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommunity->addProducts($this);
             */
        }
    ...
    public function initTransactions($overrideExisting = true)
    {
        ...
        $this->collTransactions->setModel('\ShoppingList\Model\Transaction');
    }
     ...
     * @return ObjectCollection|ChildTransaction[] List of ChildTransaction objects
     */
    public function getTransactionsJoinUserRelatedByReportedBy(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTransactionQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByReportedBy', $joinBehavior);
     ...
     * @return ObjectCollection|ChildTransaction[] List of ChildTransaction objects
     */
    public function getTransactionsJoinUserRelatedByEditedBy(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTransactionQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByEditedBy', $joinBehavior);
     ...
     * @return ObjectCollection|ChildTransaction[] List of ChildTransaction objects
     */
    public function getTransactionsJoinUserRelatedByBoughtBy(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTransactionQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByBoughtBy', $joinBehavior);
     ...
     * @return ObjectCollection|ChildTransaction[] List of ChildTransaction objects
     */
    public function getTransactionsJoinUserRelatedByCancelledBy(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTransactionQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aCommunity) {
            $this->aCommunity->removeProduct($this);
        }
        $this->idproduct = null;
        $this->idcommunity = null;
        $this->name = null;
        $this->addedby = null;
        $this->insuggestions = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
        $this->resetModified();
